...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.cleanedTiles = []  # initialize an array that holds the position of cleaned tiles
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return self.width * self.height  # multiply width and height to find area
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room.cleanTileAtPosition(self.position)  # cleans the tile it is on
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(next_position) is False:
